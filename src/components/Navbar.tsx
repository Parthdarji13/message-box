...
export default function Navbar() {
    ...
    return (
        ...
        <style>{`
            ...
            .logout-btn {
                background: transparent; border: 1px solid rgba(255,68,102,0.2);
                border-radius: 4px; padding: 0 12px; height: 32px;
                color: rgba(255,68,102,0.5); font-size: 11px; letter-spacing: 1px;
            ...
            .login-btn {
                background: transparent; border: 1px solid rgba(0,255,200,0.2);
                border-radius: 4px; padding: 0 16px; height: 32px;
                color: rgba(0,255,200,0.6); font-size: 11px; letter-spacing: 1px;
                cursor: pointer; transition: all 0.2s;
        ...
        <nav style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                {status === 'loading' ? (
                    <span style={{ fontSize: '12px', color: 'rgba(0,255,200,0.3)' }}>...</span>
                ) : session ? (
                    <>
